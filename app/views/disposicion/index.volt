    ...
    <div class="col-md-12  bg-gray">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#EntreNumeros" data-toggle="tab">Entre Números de Disposiciones</a></li>
            </ul>
            <div class="tab-content">
                <div class="active tab-pane" id="busquedaGeneral">
                    ...
                    <div class="form-group">
                        <label for="nro_disposicion" class="col-sm-2 control-label">Nro Disposicion</label>

                        <div class="col-sm-4">
                            {{ text_field('nro_disposicion','class': 'form-control','placeholder':'Ingrese el Nro de Disposicion') }}
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="porSectorYFecha">
                    {{ form('disposicion/searchEntreFechas','method':'POST','class':'form-horizontal') }}
                    <div class="form-group">
                        {{ form.label('sector_id_oid',['class': 'col-sm-2 control-label']) }}
                        <div class="col-sm-4">
                ...
                <div class="tab-pane" id="EntreNumeros">
                    {{ form('disposicion/searchEntreNumeros','method':'POST','class':'form-horizontal') }}
