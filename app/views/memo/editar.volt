{{ form("memo/save", "method":"post",'id':'nuevo','enctype':'multipart/form-data') }}
{{ content() }}
{{ flashSession.output() }}
<div class="row">
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        <div id="otro" class="form-group ocultar" style="width: 100%">
            ...
            <script>
                ...
                input.value = '{{ memo.getOtrodestino() }}';
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {{ text_field('memo_adjunto_prev','value':memo.getMemoAdjunto(),'class':'form-control','readOnly':'','placeholder':'SIN ADJUNTO') }}
        </div>
        <div class="form-group">
            <label for="memo_adjunto">Adjuntar Archivo</label>
            <input type="file"  id="memo_adjunto" name="memo_adjunto">
            <p class="help-block text-red"><i class="fa fa-warning"></i> Recuerde que los archivos adjuntos se reemplazarán definitivamente</p>        </div>
