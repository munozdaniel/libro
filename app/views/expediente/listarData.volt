...
<script>
    ...
    function format ( d ) {
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
                '<tr>'+
                estado +
                '<td><a class="btn btn-default" href="/libro/expediente/ver/'+ d.id_documento+'" target="_blank"> <i class="fa fa-file"></i> Ver Detalles </a></td>'+
                '<td></td>'+
                '<td> <a class="btn btn-default" href="/libro/caratula/expediente/'+ d.id_documento+'" target="_blank"> <i class="fa fa-file-o"></i> Caratula </a></td>'+
                '</table>';
    }
    $(document).ready(function() {
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "/libro/expediente/listarDataAjax",
                "type": "POST"
            },
            "columns": [
                {
